...
def hydrogen_observable_measurement(q_op: QubitOperator) -> Tuple[Callable[[cirq.Circuit, Callable[[List[cirq.Qid]], List[cirq.Operation]], List[cirq.Qid], int], float], int]:
    """
    Prepares an observable measurement function.
    Not yet general but specific for the H2 Hamiltonian objective.
    :param q_op: Hamiltonian observable in the form of qubit operators.
